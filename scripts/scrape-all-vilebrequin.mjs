#!/usr/bin/env node
/**
 * Script pour scraper TOUTES les images VILEBREQUIN depuis GlobalOnline
...
/**
 * Récupère les codes produits VILEBREQUIN depuis Google Sheets
 */
async function getVilebrequinCodesFromSheet() {
    console.log('📋 Récupération des codes VILEBREQUIN depuis Google Sheets...');
    ...
    try {
        ...
        // Si pas trouvé par label, utiliser colonne G (index 6)
        ...
        for (const row of rows) {
            ...
            if (itemCode) {
                // Extraire le code produit de itemCode
                // Format: PYRE9000-315-OS -> PYRE9000
                // ou: JIMC3B27-390-OS -> JIMC3B27
...
async function main() {
    console.log('🚀 Scraping VILEBREQUIN depuis GlobalOnline');
    console.log('='.repeat(60));
    
    // Récupérer les codes depuis Google Sheets
    const productCodes = await getVilebrequinCodesFromSheet();
